...
def parse_prediction(split, scene_ids, pred_file_root_path):
    pred_dict = {}
    for scene_id in scene_ids:
        with open(os.path.join(pred_file_root_path, split, f"{scene_id}.json"), "r") as f:
...
def main(cfg):
    ...
    # prepare predictions
    pred_data = parse_prediction(split, scene_ids, cfg.pred_path)

    cfg.data.evaluator._target_ = 'dlisa.evaluation.multi3drefer_evaluator.Multi3DReferEvaluator'
